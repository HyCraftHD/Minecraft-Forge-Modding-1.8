...
public class BlockDimPortal extends BlockBreakable {
	...
	public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
		if (entityIn.ridingEntity == null && entityIn.riddenByEntity == null) {
			if (entityIn.timeUntilPortal > 0) {
				...
				if (!entityIn.worldObj.isRemote && !pos.equals(getField(Entity.class, entityIn, "field_181016_an"))) {
					setField(Entity.class, entityIn, "field_181016_an", pos);
					BlockPattern.PatternHelper blockpattern$patternhelper = this.func_181089_f(entityIn.worldObj, pos);
					...
					double d1 = blockpattern$patternhelper.getFinger().getAxis() == EnumFacing.Axis.X ? entityIn.posZ : entityIn.posX;
					...
					double d2 = MathHelper.func_181160_c(entityIn.posY - 1.0D, (double) blockpattern$patternhelper.func_181117_a().getY(), (double) (blockpattern$patternhelper.func_181117_a().getY() - blockpattern$patternhelper.func_181119_e()));
					setField(Entity.class, entityIn, "field_181017_ao", new Vec3(d1, d2, 0.0D));
					setField(Entity.class, entityIn, "field_181018_ap", blockpattern$patternhelper.getFinger());
				}
	...
	private Object getField(Class clazz, Object obj, String fieldstr) {
		try {
	...
	private void setField(Class clazz, Object obj, String fieldstr, Object value) {
		try {
			Field field = clazz.getDeclaredField(fieldstr);
			field.setAccessible(true);
			field.set(obj, value);
	...
	public boolean func_176548_d(World worldIn, BlockPos p_176548_2_) {
		BlockDimPortal.Size blockportal$size = new BlockDimPortal.Size(worldIn, p_176548_2_, EnumFacing.Axis.X);

		if (blockportal$size.func_150860_b() && blockportal$size.field_150864_e == 0) {
			blockportal$size.func_150859_c();
			return true;
		} else {
			BlockDimPortal.Size blockportal$size1 = new BlockDimPortal.Size(worldIn, p_176548_2_, EnumFacing.Axis.Z);
	...
	public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock) {
		...
		if (enumfacing$axis == EnumFacing.Axis.X) {
			BlockDimPortal.Size blockportal$size = new BlockDimPortal.Size(worldIn, pos, EnumFacing.Axis.X);
			...
			BlockDimPortal.Size blockportal$size1 = new BlockDimPortal.Size(worldIn, pos, EnumFacing.Axis.Z);
	...
	public BlockPattern.PatternHelper func_181089_f(World p_181089_1_, BlockPos p_181089_2_) {
		...
		BlockDimPortal.Size blockportal$size = new BlockDimPortal.Size(p_181089_1_, p_181089_2_, EnumFacing.Axis.X);
		...
		if (!blockportal$size.func_150860_b()) {
			...
			blockportal$size = new BlockDimPortal.Size(p_181089_1_, p_181089_2_, EnumFacing.Axis.Z);
		}
	...
	public static class Size {
		...
		protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
			...
			for (i = 0; i < 22; ++i) {
				...
				if (!this.func_150857_a(this.world.getBlockState(blockpos).getBlock()) || this.world.getBlockState(blockpos.down()).getBlock() != DimMain.stone) {
					break;
				}
			}
		...
		protected int func_150858_a() {
			...
			for (int j = 0; j < this.field_150868_h; ++j) {
				if (this.world.getBlockState(this.field_150861_f.offset(this.field_150866_c, j).up(this.field_150862_g)).getBlock() != DimMain.stone) {
